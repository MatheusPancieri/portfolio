  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="w-3.5 h-3.5 rounded-full bg-[#e25d33] border border-line hover:brightness-110" />
        </button>
        <button
          ...
          className="p-1.5 -m-1.5 flex items-center justify-center cursor-pointer"
        >
          <span className="w-3.5 h-3.5 rounded-full bg-accent border border-line hover:brightness-110" />
        </button>
        <button
          ...
          className="p-1.5 -m-1.5 flex items-center justify-center cursor-pointer"
        >
          <span className="w-3.5 h-3.5 rounded-full bg-[#8a9a5b] border border-line hover:brightness-110" />
        </button>
