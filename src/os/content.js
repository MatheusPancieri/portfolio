...
const en = {
  ...
  home: {
    ...
    intro:
      "Welcome to my desktop. Everything here works like a tiny operating system — open the apps to know me better.",
  ...
  about: {
    ...
    bio: "I'm a Computer Engineering student from Brazil, based in Campo Grande, with experience in web development using .NET, ASP.NET, EF Core, SQL, JavaScript, jQuery, HTML/CSS, and Tailwind. I also design user interfaces in Figma, aiming for clean, responsive, and user-friendly layouts.",
    experiences: [
      {
  ...
  chess: {
    ...
    note: "I'm building a chess game to live right here. Check back later!",
  },
  mobile: {
    close: "Close",
  },
...
const pt = {
    ...
    experiences: [
      {
        ...
        description:
          "No GrupoSix, atuo em diferentes áreas de desenvolvimento web e deploy. Minhas responsabilidades incluem publicar sites, gerenciar arquivos e ambientes de hospedagem, configurar domínios e ajustar sites existentes. Também participo da criação de produtos e novas páginas usando Tailwind CSS, HTML, CSS, JavaScript e React.",
        highlight: [
          "Deploy",
  ...
  chess: {
    title: "chess.com",
    comingSoon: "Em breve",
    note: "Estou construindo um jogo de xadrez para morar aqui. Volte depois!",
  },
  mobile: {
    close: "Fechar",
  },
