...
const TimelineItem = ({ item }) => (
  <div className="relative border-l-2 border-line/30 pl-5 pb-2">
    <span className="absolute -left-[7px] top-1 h-3 w-3 rounded-full bg-accent border-2 border-line" />
    ...
    <p className="mt-2 text-ink/80 text-sm font-inter leading-relaxed">
      {item.description}
    </p>
